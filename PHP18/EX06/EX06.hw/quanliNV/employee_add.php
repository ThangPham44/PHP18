...
<body>
    ...
    <hr>
        <form action="employee_add_process.php" method="POST" role="form" enctype="multipart/form">
            ...
            <div class="form-group">
               ...
               <div class="form-group">
                ...
                <input type="password" class="form-control" id="" placeholder="Nhập địa chỉ" name="password">
            </div>
             <!--div class="form-group">
