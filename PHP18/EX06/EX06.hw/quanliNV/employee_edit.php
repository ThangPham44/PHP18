...
<body>
    <div class="container">
        ...
        <hr>
        <form action="employee_edit_process.php" method="POST" role="form" enctype="multipart/form">
            ...
            <div class="form-group">
                <label for="">address</label>
                <input type="text" class="form-control" id="" placeholder="Nhập địa chỉ" name="address" value="<?=$row['password']?>">
            </div>
             <!--div class="form-group">
